...
(custom-theme-set-faces
 ...
 `(font-lock-constant-face      ((t (:foreground "#D4D4D4"))))
 ...
 `(font-lock-preprocessor-face  ((t (:foreground "#569CD6"))))
 ...
 `(line-number ((t (:background "#1E1E1E" :foreground "#858585"))))
 ...
 `(tree-sitter-hl-face:function            ((t :foreground "#D4D4D4")))
 `(tree-sitter-hl-face:function.call       ((t :foreground "#D4D4D4")))
 ...
 `(tree-sitter-hl-face:variable            ((t :foreground "#D4D4D4")))
 ...
 `(markdown-code-face             ((t :foreground "#D4D4D4" :background "#2B2B2B" :extend t :inherit nil)))
 ...
 `(markdown-metadata-value-face   ((t :foreground "#D4D4D4")))

 `(org-block   ((t :foreground "#D4D4D4" :background "#2B2B2B" :extend t :inherit nil)))
 ...
 ;; modeline
 `(mode-line ((t :foreground "#D4D4D4" :background "#2A2D38")))
 `(mode-line-inactive ((t :foreground "#D4D4D4" :background "#2A2D38")))
 `(mode-line-highlight ((t :foreground "#D4D4D4" :background "#2A2D38")))

 `(minibuffer-prompt ((t (:foreground "#68CDFE"))))
 )
