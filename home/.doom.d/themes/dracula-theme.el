...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default / basic faces
               ...
               ;; syntax / font-lock
               (font-lock-builtin-face :foreground ,dracula-green )
               ...
               (font-lock-preprocessor-face :foreground ,dracula-pink)
               ...
               (font-lock-type-face :foreground, dracula-cyan)
               (font-lock-variable-name-face :foreground ,dracula-orange)
               (font-lock-warning-face :inherit warning :background ,bg2)
               (highlight-numbers-number :foreground, dracula-purple)
