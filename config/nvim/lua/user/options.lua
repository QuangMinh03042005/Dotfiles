local options = {
    ...
    shiftwidth = 4, -- the number of spaces inserted for each indentation tabstop = 4, -- insert 2 spaces for a tab
...
set foldlevel=10
set smoothscroll
let g:matchparen_timeout = 0
let g:matchparen_insert_timeout = 0
set ttyfast
set lazyredraw
]])
